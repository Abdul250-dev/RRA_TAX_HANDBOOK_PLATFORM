    ...
    <form className="flex w-full flex-col gap-6" onSubmit={handleSubmit}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full border-0 border-b border-b-[rgba(9,21,76,0.22)] bg-transparent px-0 pb-2.5 pl-9 pr-9 pt-2.5 text-[0.95rem] text-[var(--rra-blue)] outline-none placeholder:text-[rgba(9,21,76,0.46)] focus:border-b-[var(--rra-orange)]"
        ...
        <button
          type="button"
          className="absolute right-0 top-1/2 -translate-y-1/2 p-1 text-[var(--rra-blue-secondary)] hover:text-[var(--rra-blue)] transition-colors"
